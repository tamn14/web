        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <form class="search-form" action="search-ad.php?">
                            <i class="icon-search"></i>
                            <input type="search" class="form-control" placeholder="Search Here" title="Search here" name="query">
                        </form>
                    </li>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="charts">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="thongkedoanhthu.php">Thống kê doanh
                                        thu</a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . $row["Số lượng tồn kho"] . "</td>";
                                            ...
                                            echo "<tr><td colspan='10' class='text-center'>Không tìm thấy sản phẩm phù hợp.</td></tr>";
                                        }
