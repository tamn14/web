                      ...
                      <a href="#" class="btn btn-primary text-white me-0"><i class="icon-download"></i> Export</a>
                                ...
                                <table id="example" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT COUNT(*) AS total_records FROM khuyenmai s JOIN KM_SP k on s.KM_MA = k.KM_MA ";
                                        ...
                                        $sql = " SELECT * 
                                                FROM khuyenmai n
                                                left join km_sp k on k.KM_MA = n.KM_MA 
                                                left JOIN sanpham l ON k.SP_MA = l.SP_MA  
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<tr>";
                                                echo "<td>" . $row["KM_MA"] . "</td>";
                                                echo "<td>" . $row["SP_MA"] . "</td>";

                                                echo "<td class='text-wrap'>" . $row["KM_TGBD"] . "</td>";
                                                echo "<td class='text-wrap'>" . $row["KM_TGKT"] . "</td>";
                                                // echo "<td>" . number_format($row["GSP_DONGIA"], 0, ',', '.') . " VND</td>";
                                                echo "<td>" .  $row["KM_GTRI"] . "</td>";
                                                echo "<td>";
                                                echo "<a href='edit_khuyenmai.php?id=" . $row["KM_MA"] . "' class='btn btn-warning btn-sm'><i class='bi bi-pencil-square'></i> Sửa</a> ";
                                                echo "<a href='delete_khuyenmai.php?KM_MA=" . $row["KM_MA"] . "&SP_MA=" . $row["SP_MA"] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Bạn có chắc chắn muốn xóa sản phẩm này không?\")'><i class='bi bi-trash'></i> Xóa</a>";
                                ...
                                <div class="container mt-5">
                                    <div class="card shadow-sm">
                                        ...
                                        <div class="card-body">
                                            <form action="add_khuyenmai.php" method="POST" id = "km"  onsubmit="formKM(event)">
                                                <div class="mb-3">
                                                    <div id="error_ma_km" class="text-danger fst-italic">
                                                        <?php
                                                ...
                                                <div class="mb-3">
                                                    <div id="error_masp" class="text-danger fst-italic">
                                                        <?php
                                                ...
                                                <div class="mb-3">
                                                    <div id="error_tgbd" class="text-danger fst-italic">
                                                        <?php
                                                        // if (isset($_SESSION['error_tgbd'])) {
                                                        //     echo $_SESSION['error_tgbd'];
                                                        //     unset($_SESSION['error_tgbd']);
                                                        // }
                                                        ?>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    <div id="error_tgkt" class="text-danger fst-italic">
                                                        <?php
                                                        // if (isset($_SESSION['error_tgkt'])) {
                                                        //     echo $_SESSION['error_tgkt'];
                                                        //     unset($_SESSION['error_tgkt']);
                                                        // }
                                                        ?>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    <div id="error_gtkm" class="text-danger fst-italic">
                                                        <?php
                                                        // if (isset($_SESSION['error_gtkm'])) {
                                                        //     echo $_SESSION['error_gtkm'];
