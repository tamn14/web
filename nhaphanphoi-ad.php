                      ...
                      <a href="#" class="btn btn-primary text-white me-0"><i class="icon-download"></i> Export</a>
                                ...
                                <table id="example" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT COUNT(*) AS total_records FROM nhaphanphoi";
                                        ...
                                        $sql = " SELECT * 
                                                FROM  nhaphanphoi where NPP_VOHH = '1'" ; 
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<tr>";
                                                echo "<td>" . $row["NPP_MA"] . "</td>";
                                                echo "<td>" . $row["NPP_TEN"] . "</td>";
                                                ...
                                                echo "<td>";
                                                echo "<a href='edit_NPP.php?id=" . $row["NPP_MA"] . "' class='btn btn-warning btn-sm'><i class='bi bi-pencil-square'></i> Sửa</a> ";
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                        } else {
                                ...
                                <div class="container mt-5">
                                    <div class="card shadow-sm">
                                        <div class="card-header bg-primary text-white">
                                            ...
                                            <h4>Thêm Nhà Phân Phối Mới</h4>
                                        </div>
                                        <div class="card-body">
                                            <form action="add_nhaphanphoi.php" method="POST" id = "npp" onsubmit="formnpp(event)">
                                                <div class="mb-3">
                                                    ...
                                                    <label for="ma_km" class="form-label">Mã nhà phân phối</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label for="ma_sp" class="form-label">Tên nhà phân phối</label>
                                                ...
                                                <button type="submit" class="btn btn-success">Thêm Nhà Phân Phối</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
