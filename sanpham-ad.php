              ...
              <div class="home-tab">
                  ...
                  <tbody>
                    ...
                    $sql = " SELECT 
                              ...
                              LEFT JOIN (
                                  SELECT 
                                     *
                                  FROM PHIEUNHAP pn
                                  WHERE (SP_MA, PN_NGAYNHAP) IN (
                                      SELECT 
                                          SP_MA, 
                                          MAX(PN_NGAYNHAP) AS PN_NGAYNHAP
                                      FROM PHIEUNHAP
                                      GROUP BY SP_MA
                                  )
                              ) pn_moi ON pn_moi.SP_MA = s.SP_MA
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . number_format($row["PN_PBGIA"], 0, ',', '.') . " VND</td>";
                        echo "<td>";
                ...
                <div class="container mt-5">
                  <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                      <form id ="sanpham-ad" action="add_product.php" method="POST" enctype="multipart/form-data" onsubmit="themSanPham(event)">
                        <div class="mb-3">
                          <div id="error_ten" class="text-danger fst-italic">
                            <?php
                        ...
                        <div class="mb-3">
                          <div id="error_gia" class="text-danger fst-italic">
                            <?php
                          ...
                          <label for="SP_gia" class="form-label">Giá niêm yết</label>
                          <input type="number" class="form-control" id="SP_gia" name="SP_gia">
                        </div>
                        <div class="mb-3">
                          <div id="error_sl" class="text-danger fst-italic">
                            <?php
                          ...
                          <input type="number" class="form-control" id="sl" name="SP_sl">
                        </div>
                        <div class="mb-3">
                          <div id="error_mota" class="text-danger fst-italic">
                            <?php
                        ...
                        <div class="mb-3">
                          <div id="error_npp" class="text-danger fst-italic">
                            <?php
                            // if (isset($_SESSION['error_NPP'])) {
                            //   echo $_SESSION['error_NPP'];
                            //   unset($_SESSION['error_NPP']);
                            // }
                            ?>
                          </div>
                          <label for="npp" class="form-label">Nhà phân phối</label>
                          <select class="form-control" id="npp" name="npp">
                            ...
                            include 'db.php';
                            $sql = "SELECT NPP_MA, NPP_TEN FROM nhaphanphoi where NPP_VOHH = '1' ";
                            $result = $conn->query($sql);
                          ...
                          <div class="mb-3">
                            <div id="error_gianhap" class="text-danger fst-italic">
                              <?php
                              // if (isset($_SESSION['error_gianhap'])) {
                              //   echo $_SESSION['error_gianhap'];
                              //   unset($_SESSION['error_gianhap']);
                              // }
                              ?>
                            </div>
